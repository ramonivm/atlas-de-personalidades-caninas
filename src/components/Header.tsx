  ...
  return (
    <header className="bg-neutral-950/90 text-slate-200 border-b border-white/5 sticky top-0 z-30 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 space-y-3">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden pt-2 pb-1 border-t border-neutral-800/80 animate-content-fade-in">
        ...
        <div className="hidden md:flex w-full justify-center" ref={desktopNavRef}>
